...
var Slider = vue.defineComponent({
  ...
  setup: function setup(props, _ref) {
    var emit = _ref.emit;
    var tipsValue = vue.ref(0);
    var tipsShow = vue.ref(false);
    return function () {
      ...
      if (props.showstep) {
        ...
        for (var i = 1; i < number + 1; i++) {
          ...
          if (_step < 100) {
            stepRender.push(vue.createVNode("div", {
      ...
      return vue.createVNode("div", {
      ...
      }, [props.tips && tipsShow.value && vue.createVNode("div", {
      ...
      }, [min + Math.round((max - min) * tipsValue.value / 100)]), vue.createVNode("div", {
        ...
        "ref": function ref(dom) {
          return wrapBtnsDom[0] = dom;
        },
        "onMousedown": function onMousedown(e) {
          return _onMousedown(0, e);
        }
      }, null)]), range && vue.createVNode("div", {
        "class": 'layui-slider-wrap',
