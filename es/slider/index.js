    ...
    return function () {
      ...
      if (props.showstep) {
        ...
        for (var i = 1; i < number + 1; i++) {
          ...
          if (_step < 100) {
            stepRender.push(_createVNode("div", {
      ...
      }, [props.tips && tipsShow.value && _createVNode("div", {
      ...
      }, [min + Math.round((max - min) * tipsValue.value / 100)]), _createVNode("div", {
