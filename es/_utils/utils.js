...
export var toLine = function toLine(name) {
  return name.replace(/([A-Z])/g, '-$1').toLowerCase();
};
export var emptyFun = function emptyFun() {// 空函数
};
export function triggerElement(arr, item) {
...
export function arrayEqual(obj1, obj2) {
